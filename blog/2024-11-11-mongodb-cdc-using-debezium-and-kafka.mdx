...
title: "MongoDB CDC with Debezium & Kafka | Real-Time Data Streaming"
description: "Learn how Debezium and Kafka enable real-time Change Data Capture (CDC) from MongoDB for efficient, scalable data integration pipelines."
...
![MongoDB CDC to lakehouse: Debezium and Kafka Connect stream changes from MongoDB into a lakehouse architecture](/img/blog/cover/mongodb-cdc-using-debezium-and-kafka-cover.webp)
...
![MySQL and PostgreSQL stream changes via Debezium into Kafka, with sink connectors delivering to Elastic, Infinispan, and data warehouses](/img/blog/2024/11/mongodb-cdc-using-debezium-and-kafka-1.webp)
