---
title: "Full Streams Configuration with Partitioning - OLake"
description: "Configure complete OLake streams with advanced partitioning, chunking, normalization, and sync mode settings for data replication."
---
