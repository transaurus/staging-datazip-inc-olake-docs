---
title: "Local Sync with State PostgreSQL - OLake CLI"
description: "Run OLake PostgreSQL sync with state management locally. Track sync progress and enable incremental updates with state files."
---
