---
title: "Local Sync MySQL Command - OLake CLI"
description: "Run OLake sync locally for MySQL databases. Replicate MySQL tables to Apache Iceberg with full refresh and CDC support."
---
