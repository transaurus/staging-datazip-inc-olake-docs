...
---
title: "Local Sync PostgreSQL Command - OLake CLI"
description: "Run OLake sync command locally for PostgreSQL data replication. Sync database tables to Apache Iceberg or Parquet formats."
---
