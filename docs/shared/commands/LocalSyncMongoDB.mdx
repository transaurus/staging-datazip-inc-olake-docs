...
---
title: "Local Sync MongoDB Command - OLake CLI"
description: "Execute OLake sync locally for MongoDB collections. Replicate MongoDB data to Apache Iceberg with CDC and incremental sync."
---
