---
title: "Local Sync with State MongoDB Command - OLake CLI"
description: "Execute OLake sync with state management for MongoDB locally. Maintain sync state for incremental updates and CDC operations."
---
