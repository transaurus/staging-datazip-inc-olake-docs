---
title: "Iceberg Lakehouse on Azure Setup Guide | OLake"
description: Build a scalable Iceberg lakehouse on Azure with OLake and Lakekeeper for seamless data pipelines using ADLS Gen2 and REST catalog integration
sidebar_label: Iceberg On Azure
sidebar_position: 2
---
...
![Azure create storage account, Advanced tab, with option to enable hierarchical namespace](/img/docs/adls/azure-adls-2.webp)
...
![Azure portal showing new container creation, with the name "warehouse-dev" and private access set.](/img/docs/adls/azure-adls-3.webp)
...
![Azure add role assignment screen assigning "Storage Blob Data Owner" to the "Warehouse (Dev)" application](/img/docs/adls/azure-adls-4.webp)
...
![Screenshot of OLake Iceberg destination config with REST Catalog, Iceberg S3 path, and Azure Data Lake endpoint.](/img/docs/adls/azure_dest.png)
