...
![OLake, AWS Glue, and Snowflake integration](/img/blog/cover/olake-glue-snowflake-cover.webp)
...
![Snowflake UI DESCRIBE EXTERNAL VOLUME for s3_iceberg_volume showing allowed writes and storage locations](/img/blog/2025/05/olake-glue-snowflake-1.webp)
...
![Snowflake console showing Glue catalog integration properties table](/img/blog/2025/05/olake-glue-snowflake-2.webp)
...
![Snowflake UI showing SQL query and tabular query results](/img/blog/2025/05/olake-glue-snowflake-3.webp)
