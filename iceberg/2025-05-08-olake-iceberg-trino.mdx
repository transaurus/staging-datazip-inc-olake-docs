...
image: /img/blog/cover/olake-iceberg-trino-cover.webp
authors: [merlyn]
...
![OLake, Iceberg Glue Catalog, and Trino integration](/img/blog/cover/olake-iceberg-trino-cover.webp)
...
![Trino terminal window showing DESCRIBE query for iceberg.olake_product.customer with column names and types](/img/blog/2025/05/olake-iceberg-trino-1.webp)
...
![Trino terminal showing SELECT query results from iceberg.olake_product.customer table with columns like _olake_id, customer_id, account_number, name, and timestamps](/img/blog/2025/05/olake-iceberg-trino-2.webp)
