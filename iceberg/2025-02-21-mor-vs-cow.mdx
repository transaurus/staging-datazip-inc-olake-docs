...
image: /img/blog/cover/mor-vs-cow-cover.webp
authors: [aakash]
tags: [iceberg]
---
...
![Apache Iceberg Copy-on-Write vs Merge-on-Read](/img/blog/cover/mor-vs-cow-cover.webp)
...
![Apache Iceberg metadata and data file architecture diagram, showing catalog, metadata, manifest, and data layers with file relationships](/img/blog/2025/02/mor-vs-cow-1.webp)
...
![Table comparing Copy-on-Write and Merge-on-Read in terms of query runtime and data scanned for UPDATE, DELETE, and SELECT operations](/img/blog/2025/02/mor-vs-cow-2.webp)
