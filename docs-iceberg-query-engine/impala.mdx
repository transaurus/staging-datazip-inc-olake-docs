---
title: Apache Impala with Iceberg v2 | OLake Fast Query Engine
description: Explore OLake's high-performance Apache Impala integration with Iceberg v2 for enterprise analytics, ACID compliance, and advanced SQL time travel.
sidebar_label: Apache Impala v4.4+
...
export const impalaTableData = {
  ...
  rows: [
    ...
    },
    {
      ...
      details: { 
        value: "INSERT, DELETE, UPDATE with [position deletes](/blog/iceberg-delta-lake-delete-methods-comparison/); MERGE in CDW 1.5.5 preview",
...
<QueryEngineLayout
  ...
  faqMainEntity={queryEngineFaq.impala}
