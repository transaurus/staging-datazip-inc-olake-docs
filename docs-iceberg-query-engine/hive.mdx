---
title: "Apache Hive 4.0+ & Apache Iceberg Integration | OLake Analytics"
description: "Discover OLake's support for Apache Iceberg tables in Hive 4.0+, including full SQL DML, hidden partitioning, Ranger security, and batch analytics with Tez execution."
sidebar_label: Apache Hive 4.0+
...
export const hiveFeatures = [
  ...
  },
  {
    ...
    details: {
      ...
      overviewContent: {
        strengths: [
          "Full DELETE, UPDATE, [MERGE](/iceberg/query-engine/spark) INTO support",
...
<QueryEngineLayout
  ...
  faqMainEntity={queryEngineFaq.hive}
