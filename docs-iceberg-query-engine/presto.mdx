---
title: "Presto 0.288+ & Apache Iceberg: Distributed SQL Analytics | OLake"
description: "Explore OLake's support for Presto 0.288+ with Apache Iceberg, featuring multi-catalog support, DML operations, time travel, and advanced query optimizations for data lakes."
sidebar_label: Presto 0.288+
...
export const prestoFeatures = [
  ...
  },
  {
    ...
    chip: "[AS OF TIMESTAMP](/blog/apache-polaris-lakehouse) Syntax",
...
<QueryEngineLayout
  title="Presto 0.288+"
  schemaTitle="Presto 0.288+ & Apache Iceberg: Distributed SQL Analytics | OLake"
  schemaDescription="Explore OLake's support for Presto 0.288+ with Apache Iceberg, featuring multi-catalog support, DML operations, time travel, and advanced query optimizations for data lakes."
  faqMainEntity={queryEngineFaq.presto}
  description={
    <>
