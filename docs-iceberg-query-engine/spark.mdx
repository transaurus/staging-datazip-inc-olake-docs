---
title: "Apache Spark 3.3+ & Apache Iceberg Integration | OLake Analytics"
description: "Explore OLake's support for Apache Iceberg on Spark 3.3+, including full DML, schema evolution, ACID transactions, streaming, time travel, and enterprise security features."
sidebar_label: Apache Spark 3.3+
...
VERSION AS OF 1234567890`
            ...
            {
              title: "[Timestamp-based Query](/blog/apache-polaris-lakehouse)",
...
<QueryEngineLayout
  ...
  faqMainEntity={queryEngineFaq.spark}
  features={sparkFeatures}
  tableData={sparkTableData}
  useCases={sparkUseCases}
  officialDocs="https://spark.apache.org/docs/latest/"
