---
title: "Apache Flink 1.18+ & Apache Iceberg CDC Integration | OLake"
description: "Learn about OLake's reference implementation for Apache Iceberg with Apache Flink 1.18+, including streaming CDC support, exactly-once semantics, incremental reads, and metadata management."
sidebar_label: Apache Flink 1.18+
...
<QueryEngineLayout
  ...
  faqMainEntity={queryEngineFaq.flink}
